...
Partial Class MDIParent1
    ...
    Private Sub InitializeComponent()
        ...
        TimesToolStripMenuItem = New ToolStripMenuItem()
        ...
        ' MenuStrip
        ' 
        MenuStrip.Items.AddRange(New ToolStripItem() {FileMenu, EditMenu, ViewMenu, ToolsMenu, WindowsMenu, HelpMenu, AgeToolStripMenuItem, TimesToolStripMenuItem})
        ...
        ToolsMenu.Size = New Size(48, 20)
        ToolsMenu.Text = "tester"
        ' 
        ...
        WindowsMenu.Size = New Size(37, 20)
        WindowsMenu.Text = "Eve"
        ' 
        ...
        AgeToolStripMenuItem.Size = New Size(40, 20)
        ...
        ' 
        TimesToolStripMenuItem.Name = "TimesToolStripMenuItem"
        TimesToolStripMenuItem.Size = New Size(48, 20)
        TimesToolStripMenuItem.Text = "times"
        ' 
        ' MDIParent1
        ' 
